...
You can see the current code (not refactored like above) for Order in link:files/app/models/order.rb
...
You can see the current code for OrderStatus at link:files/app/models/order_status.rb
You can see the current code for Status at link:files/app/models/status.rb
